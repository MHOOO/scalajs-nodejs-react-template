...
(function () {
    ...
    var app = require("./target/scala-2.11/app-backend-fastopt-bundle.js");
    // var app = require("./target/scala-2.11/app-backend-fastopt.js").__ScalaJSExportsNamespace.app;
    // require("./target/scala-2.11/app-backend-jsdeps.js")
    // var app = require("./target/scala-2.11/app-backend-opt-bundle.js").__ScalaJSExportsNamespace.app;
    console.log(app);
